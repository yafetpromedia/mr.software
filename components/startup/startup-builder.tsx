...
const DEPLOY_OPTIONS = [
  { icon: Cloud, label: "Mr.Software Cloud", status: "Coming soon" },
      ...
      <div className="relative overflow-hidden rounded-2xl border border-[var(--border)] bg-[var(--surface)] p-6 sm:p-8">
        ...
        <div className="relative">
          ...
          <p className="mt-2 max-w-2xl text-sm leading-relaxed text-[var(--muted)] sm:text-[0.95rem]">
            AI suggests structure, UI drafts, and architecture — you review, edit, export, and choose
            where to deploy. Real builder ownership, not full automation.
          </p>
        </div>
      </div>
        ...
        <div className="modern-card space-y-5 p-5 sm:p-6">
          <div>
            ...
            <p className="mt-0.5 text-xs text-[var(--muted)]">
              Be specific — audience, problem, and what you want to sell.
            </p>
          </div>
          ...
          <div className="relative">
            <textarea
              ...
              placeholder="e.g. AI-powered fitness tracker for busy professionals…"
            />
          ...
          <div className="rounded-xl border border-[var(--border)] bg-[var(--background)]/50 p-4">
            ...
            <ul className="mt-3 space-y-2.5">
              {DEPLOY_OPTIONS.map((opt) => {
                const Icon = opt.icon;
                return (
                  <li key={opt.label} className="flex items-center gap-3 text-xs">
                ...
                {recent.map((s) => (
                  <li key={s.id}>
                    <button
                      ...
                      className="group flex w-full items-center gap-3 rounded-xl border border-transparent px-3 py-2.5 text-left transition hover:border-[var(--border)] hover:bg-[var(--surface)]"
                    >
